...
class DocNavLandingApp extends StatelessWidget {
        ...
        children: [
          ...
          Row(
            ...
            children: const [
              ...
              SizedBox(width: 40),
              Icon(Icons.memory, size: 80, color: Colors.blueAccent),
              SizedBox(width: 40),
          ...
          Row(
            ...
            children: [
              ElevatedButton(
                ...
                onPressed: () {Navigator.pushNamed(createElement(), '/patients');},
              ...
              OutlinedButton(
                ...
                onPressed: () { Navigator.pushNamed(createElement(), '/doctors');},
